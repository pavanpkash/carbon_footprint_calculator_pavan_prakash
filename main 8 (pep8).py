...
def instructions():
    ...
    print("\nThis program will calculate your carbon footprint, "
          "show you your emissions "
          "and give you solutions to combat climate change")
...
""")
            ...
            # when the user selects this transport,
            # every other transport will = 0 for easy calculations
            ...
            how_often = validate_float("\nHow many times a week "
                                       "do you use the bus? "
                                       "(if once per day type 7, "
                                       "if twice a day type 14): ")
            # if the user uses a bus,
            # they will be asked how often they use the bus
            ...
            how_often = validate_float("\nHow many times a week "
                                       ...
                                       "(if once per day type 7, "
                                       "if twice a day type 14): ")
            km_per_ride = validate_float("Roughly how many kilometres "
                                         "is one train ride?: ")
    ...
    # if the transport is one of the listed options,
    # it will use the final_vehicle_emission_calculator function
...
def petrol_diesel_emissions(car_type):
    ...
    while car_type in [1, 2, 3]:
        ...
        if car_type == 1:
            ...
            vehicle_emissions = round(vehicle_emissions_unrounded)
            # round is used throughout the program
            # This gives an appealing round number with no dp
            time.sleep(1)
...
def individual_electricity_calculator(monthly_household_electricity_usage,
    ...
    time.sleep(2)
    print("\nThis is", yearly_individual_electricity,
...
def electricity_questions():
    ...
    while not valid:
        ...
        # this is mainly for the younger audience who
        # may not know their electricity usage
        if does_user_know_electricity == "yes":
            monthly_household_electricity_usage = \
            ...
            print("\nThe average electricity usage of "
                  "individuals in NZ is 909kWh per month. ")
            total_electricity_emissions = individual_electricity_calculator(
    ...
    while not valid:
        ...
        if flights_yes_no == "yes":
            flightnum = validate_float("\nHow many flights have you "
                                       "taken this year?: ")
            # asks the user how many flights they have taken this year and
            # will use that number in the flying def
            ...
            flight_emissions = .09
            # passenger flights emit around 0.09 kilograms of co2
...
def flight_distance_calculator(flightnum):
    ...
    while flightnum != 0:
        ...
        while base_num <= flightnum:
            # this is so the program will stop asking for the user's
            # kilometres after their last flight
            new_flight = validate_float("How many kilometres was "
                                        "flight {} (including return)?: "
                                        .format(base_num))
            base_num = base_num + 1
        ...
        if base_num >= flightnum:
            break
            # if the base number is greater or equal to the
            # user's flights, the loop breaks
    total = sum(flights)
    return total
...
time.sleep(2)
print("\nFrom electricity usage, you emit", total_electricity_emissions,
      "kg of CO2 per year.")
...
time.sleep(1)
print("\nFrom air travel, you have emitted", total_flight_emissions,
      "kilograms of CO2 in the last year.")

carbon_footprint = final_vehicle_emissions + total_electricity_emissions + \
                   co2_from_gas + total_flight_emissions
print("Your total carbon footprint is", carbon_footprint,
      "kg of CO2 emitted per year.")

if carbon_footprint < 8600:
    print("\nAwesome! This is less than the average carbon footprint "
          "in New Zealand, which is 8,600 kg.")
    print("Here are some solutions to help lower this:"
          "- Use more economic forms of transport, including biking, "
          "walking, electric vehicles and even public transport")
    print("""- Use less LPG gas
             - Plant more trees""")
elif carbon_footprint > 8600:
    print("\nThis is greater than the average carbon footprint "
          "in New Zealand, which is 8,600kg.")
    print("Here are some solutions to help lower this:"
          "- Use more economic forms of transport, including biking, "
          "walking, electric vehicles and even public transport")
    print("""- Use less LPG gas
