...
""")
                ...
                if car_type in [1, 2, 3]:
                    ...
                    print("Please input 1 for petrol, 2 for diesel or 3 for electric.")
...
def individual_vehicle_emission_calculator():
...
final_vehicle_emissions = individual_vehicle_emission_calculator()
time.sleep(1)
